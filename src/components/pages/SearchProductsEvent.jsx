...
function SearchProductsEvent() {
  ...
  const getProducts = () => {
    axiosOrder.get(`/products/searchEvent/${params.search}`).then((response) => {
    ...
    <div>
      <MainLayout>
        <div className="flex items-center justify-center ">
          <h1 className="text-white text-3xl mr-8">Recherche dans les Articles de ventes</h1>
          <Link to="/articles-evenement">
            <svg
              width="30"
              height="64"
              viewBox="0 0 75 64"
...
export default SearchProductsEvent;
