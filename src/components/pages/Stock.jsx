  ...
  return (
    <MainLayout>
      <div className="bg-black h-full">
        <h1 className="text-white text-4xl">STOCK</h1>
        <div className="flex justify-around flex-wrap mt-8">
          <SearchBar />
          <Link to="/stock/ajout-article">
            <div className="flex items-baseline mt-2">
              ...
              <h1 className="text-white text-xl"> Ajouter un article</h1>
            </div>
          </Link>
        </div>
        <div className="flex justify-around flex-wrap-reverse">
          <ItemsList stock={true} Type={filterType} Sexe={filterSexe} Size={filterSize} />
          <Filter
